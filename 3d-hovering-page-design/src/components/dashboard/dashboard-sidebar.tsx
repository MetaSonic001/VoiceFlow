...
import { ChevronRight, Zap, Mic, BookOpen, Mail, BarChart3, Settings, Users, Phone, Webhook, Gauge, FileText, PlusCircle, Home } from 'lucide-react'
...
const navSections = [
  ...
  },
  {
    label: 'Agents',
    items: [
      { icon: PlusCircle, label: 'Create Agent', href: '/dashboard/agents/create' },

...
urlpatterns = [
    ...
    path("api/onboarding/voice/", api_proxy.onboarding_configure_voice, name="api_onboarding_voice"),
    path("api/onboarding/channels/", api_proxy.onboarding_setup_channels, name="api_onboarding_channels"),
    ...
    path("api/settings/exotel/", api_proxy.exotel_credentials, name="api_exotel_credentials"),
